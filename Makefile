...
main: $(BINDIR)/node.o $(BINDIR)/solver.o $(BINDIR)/bfs_solver.o $(BINDIR)/astar_solver.o $(BINDIR)/gbfs_solver.o $(BINDIR)/idfs_solver.o $(BINDIR)/idastar_solver.o
