...
all: $(BINDIR)/node.o $(BINDIR)/solver.o $(BINDIR)/bfs_solver.o $(BINDIR)/astar_solver.o $(BINDIR)/gbfs_solver.o $(BINDIR)/idfs_solver.o
	$(CC) -o main main.cpp $(BINDIR)/node.o $(BINDIR)/solver.o $(BINDIR)/bfs_solver.o $(BINDIR)/astar_solver.o $(BINDIR)/gbfs_solver.o $(BINDIR)/idfs_solver.o $(CFLAGS)
